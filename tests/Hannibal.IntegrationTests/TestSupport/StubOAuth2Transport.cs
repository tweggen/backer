...
///
/// This is an independent copy of the seam <c>tests/Hannibal.Tests</c> uses
/// (the integration test project deliberately does not reference the unit test
/// project). It follows the OAuth2 submodule's own NSubstitute precedent
...
///
/// Any request without a registered response throws - a test can therefore
/// never silently fall through to the real provider.
/// </summary>
